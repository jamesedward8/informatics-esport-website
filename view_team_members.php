...
<head>
    ...
    <link
        ...
        rel="stylesheet">
    <title>Members of Team <?php echo $view_team_name ?></title>
</head>
    ...
    <main class="content">
        <article>
            ...
            <div class="content-page">
                <?php
                $stmt_team_members = $mysqli->prepare("SELECT m.username, tm.description FROM team_members tm JOIN member m ON tm.idmember = m.idmember JOIN team t ON tm.idteam = t.idteam WHERE t.idteam = ?");
