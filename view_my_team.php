    ...
    <main class="content">
        <article>
            ...
            <div class="content-page">
                <?php
                $stmt_my_team = $mysqli->prepare("SELECT t.idteam, t.name FROM team_members tm JOIN team t ON tm.idteam = t.idteam WHERE tm.idmember = ?");
                ...
                while ($row_my_team = $result_my_team->fetch_assoc()) {
                    ...
                    echo "<td><a style='color:orange;' href='view_team_members.php?team-id=" . $row_my_team['idteam'] . "&team-name=" . $row_my_team['name'] . "'>View Members</a></td>";
                    echo "</tr>";
                }
